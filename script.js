...
var PROJECTS = {
  res: [
    ...
    { name:'Purva Raagam - Purvankara', thumb:B+'3e7de2_51c58abc0b984efeab42696a3741893e~mv2.png', concept:[B+'3e7de2_47950286cfd841acb88a4d6d488968a8~mv2.png'], build:[B+'3e7de2_a42f683c36e848eb9e517fda9da13a62~mv2.jpeg',B+'3e7de2_ccdf455aa6044c6091e6394b73149df3~mv2.jpeg',B+'3e7de2_4a8c0b1d1ac247e1a8a0d8af34b92478~mv2.jpeg',{collage:[B+'3e7de2_e4bd8ef069844c96b79df2bed852d197~mv2.jpeg',B+'3e7de2_4992b9f4742a4e5a92a8728a52d22d6f~mv2.jpeg',B+'3e7de2_72452fcdd3a547c1a06110920b00e5ff~mv2.jpeg',B+'3e7de2_38d01ef94bd84d79a1e86b4bf9428863~mv2.jpeg']},B+'3e7de2_282bb9a6d8be41e3a30e7de35a23c2a5~mv2.jpeg',B+'3e7de2_680e3a8643204cf1958489f5e2b8ae80~mv2.jpeg'] },
...
function hideLBVideo() {
  ...
  var cg = document.getElementById('lb-collage-grid');
  if (cg) { cg.remove(); document.getElementById('lbMainImg').parentNode.style.aspectRatio = '16/9'; }
...
function showImg(i) {
  ...
  var img = document.getElementById('lbMainImg');
  var entry = lbImgs[lbCur];
  var isCollage = entry && typeof entry === 'object' && entry.collage;

  // Remove any existing collage grid
  var existing = document.getElementById('lb-collage-grid');
  if (existing) existing.remove();

  if (isCollage) {
    img.style.display = 'none';
    // Expand the image wrap to square-ish for 2x2 grid
    img.parentNode.style.aspectRatio = '4/3';
    var grid = document.createElement('div');
    grid.id = 'lb-collage-grid';
    grid.style.cssText = 'position:absolute;inset:0;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:3px;background:#111;';
    entry.collage.forEach(function(url) {
    ...
    img.style.display = '';
    img.parentNode.style.aspectRatio = '16/9';
    img.style.opacity = '0';
    img.src = entry || '';
  ...
  for (var k = 0; k < lbImgs.length; k++) {
    (function(k2) {
      var entry2 = lbImgs[k2];
      var isC = entry2 && typeof entry2 === 'object' && entry2.collage;
      var t = document.createElement('img');
      t.className = 'lb-thumb' + (k2 === lbCur ? ' active' : '');
      t.src = isC ? entry2.collage[0] : entry2;
      t.alt = '';
