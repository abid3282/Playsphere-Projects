  ]
};
...
var RES_DEFAULT = ['Meadow Dance by Total Environment', 'Purva Raagam - Purvankara', 'Courtyard by Narang Reality'];
...
function renderProjects(sk) {
  ...
  if (sk === 'res') {
    ...
    vmWrap.style.cssText = 'grid-column:1/-1;display:flex;justify-content:center;padding:8px 0 24px;';
...
// ── INTERACTION 7: CURSOR COLOUR CYCLE ──────────────────────
// Cursor slowly cycles through brand colours — desktop only
(function() {
  if (IS_TOUCH) return;
  ...
  var t = 0;
  var duration = 3000; // ms per colour
  var current = 0;
...
if (!IS_TOUCH) {
  ...
  document.addEventListener('mouseover', function(e) {
    var t = e.target.closest('.imm-project, .imm-view-btn, button, a, .hl-card, .cover-hint');
    if (t) cur.classList.add('big'); else cur.classList.remove('big');
  });
}

// COVER LENS EFFECT (desktop only)
(function() {
  if (IS_TOUCH) return;
  var cover = document.getElementById('cover');
  var lens = document.getElementById('cover-lens');
  var lensImg = document.getElementById('cover-lens-img');
  var LENS = 220;
  ...
  function updateLens(clientX, clientY) {
    ...
    lens.style.top = y + 'px';
    var imgW = cover.offsetWidth;
    var imgH = cover.offsetHeight;
    lensImg.style.width = imgW + 'px';
    lensImg.style.height = imgH + 'px';
    lensImg.style.left = (-x + LENS / 2) + 'px';
    lensImg.style.top = (-y + LENS / 2) + 'px';
  }

  cover.addEventListener('mouseenter', function(e) { lens.classList.add('visible'); updateLens(e.clientX, e.clientY); });
  cover.addEventListener('mousemove', function(e) { updateLens(e.clientX, e.clientY); });
  cover.addEventListener('mouseleave', function() { lens.classList.remove('visible'); });
})();
...
// CONFETTI
var COLS = ['#7D9BC1','#F2C75C','#71CC98','#FB637E'];
function burst(x, y) {
  for (var i = 0; i < 20; i++) {
    ...
    el.style.cssText = [
      ...
      '--dy:' + (Math.sin(a)*d - 60).toFixed(1) + 'px',
      '--rot:' + (Math.random()*360).toFixed(0) + 'deg',
      '--dur:' + dur,
      'animation:cpFall ' + dur + ' ease-out forwards'
    ].join(';');
...
// LIGHTBOX
var lbImgs = [], lbCur = 0, lbConceptCount = 0, lbCollageSlot = -1, lbCollageUrls = [];
...
function openLB(sk, idx) {
  ...
  var m = META[sk];
  lbImgs = []; lbConceptCount = 0; lbCollageSlot = -1; lbCollageUrls = [];
  ...
  if (p.build && p.build.length) {
    var collageIdxSet = (p.collage && p.collage.buildIndices) ? p.collage.buildIndices : [];
    var collageInserted = false;
    for (var b = 0; b < p.build.length; b++) {
      if (collageIdxSet.indexOf(b) !== -1) {
        if (!collageInserted) {
          lbCollageSlot = lbImgs.length;
          lbCollageUrls = collageIdxSet.map(function(ci) { return p.build[ci]; });
          lbImgs.push('__collage__');
          collageInserted = true;
        }
      } else {
        lbImgs.push(p.build[b]);
      }
    }
  }
  document.getElementById('lbTitle').textContent = p.name;
  var badge = document.getElementById('lbBadge');
  badge.textContent = m.label; badge.style.background = m.bg;
  ...
  if (hint) hint.style.display = IS_TOUCH ? 'block' : 'none';
}
...
function hideLBVideo() {
  ...
  // Note: do NOT force-show lbMainImg here — showImg() will handle visibility
}

function hideLBCollage() {
  var existing = document.getElementById('lb-collage-grid');
  if (existing) existing.remove();
}

function showLBCollage(urls) {
  hideLBCollage();
  var img = document.getElementById('lbMainImg');
  img.style.display = 'none';
  var grid = document.createElement('div');
  grid.id = 'lb-collage-grid';
  var count = urls.length;
  // 5-image layout: big image left (spans 2 rows), 4 smaller on right (2x2)
  // grid-template-areas approach: col1=big, col2=top-right pair stacked, col3=bottom-right pair stacked
  grid.style.cssText = [
    'position:absolute','inset:0','display:grid','gap:3px','padding:0',
    count === 5
      ? 'grid-template-columns:1.4fr 1fr 1fr;grid-template-rows:1fr 1fr;'
      : 'grid-template-columns:repeat(' + Math.ceil(count/2) + ',1fr);grid-template-rows:1fr 1fr;'
  ].join(';');
  urls.forEach(function(url, ui) {
    var cell = document.createElement('div');
    // First image spans both rows in col 1
    cell.style.cssText = 'overflow:hidden;' + (ui === 0 && count === 5 ? 'grid-row:1/3;' : '');
    var im = document.createElement('img');
    im.src = url;
    im.alt = '';
    im.style.cssText = 'width:100%;height:100%;object-fit:cover;display:block;transition:transform .3s ease;';
    im.addEventListener('mouseenter', function() { im.style.transform = 'scale(1.04)'; });
    im.addEventListener('mouseleave', function() { im.style.transform = ''; });
    cell.appendChild(im);
    grid.appendChild(cell);
  });
  img.parentNode.appendChild(grid);
}
...
function showImg(i) {
  ...
  if (lbImgs[lbCur] === '__collage__') {
    img.style.display = 'none';
    showLBCollage(lbCollageUrls);
  ...
  for (var k = 0; k < lbImgs.length; k++) {
    (function(k2) {
      ...
      // For collage slot show first collage image as thumbnail
      t.src = (lbImgs[k2] === '__collage__') ? lbCollageUrls[0] : lbImgs[k2];
      t.alt = '';
...
function closeLB() { hideLBVideo(); hideLBCollage(); document.getElementById('lbMainImg').style.display = ''; document.getElementById('lightbox').classList.remove('open'); document.body.style.overflow = ''; }
...
(function() {
  ...
  document.querySelectorAll('.sector-divider-label').forEach(function(el) {
    el.style.cssText += 'opacity:0;transform:translateX(-20px);transition:opacity .7s ease,transform .7s ease;';
    var o2 = new IntersectionObserver(function(entries) {
      entries.forEach(function(e) { if (e.isIntersecting) { el.style.opacity='1'; el.style.transform='translateX(0)'; o2.unobserve(el); } });
    }, { threshold: 0.5 });
    o2.observe(el);
  });
...
(window.requestIdleCallback || function(cb){ setTimeout(cb, 1); })(function() {
  ...
  if (!IS_TOUCH) {
    // CURSOR TRAIL
    (function() {
      var TRAIL = 12, dots = [], colors = ['#7D9BC1','#F2C75C','#71CC98','#FB637E'], positions = [];
      for (var i = 0; i < TRAIL; i++) {
        var d = document.createElement('div');
        d.style.cssText = ['position:fixed','width:' + (6 - i * 0.3) + 'px','height:' + (6 - i * 0.3) + 'px','border-radius:50%','pointer-events:none','z-index:9990','transform:translate(-50%,-50%)','opacity:' + (1 - i / TRAIL),'background:' + colors[i % 4],'transition:opacity .1s'].join(';');
        document.body.appendChild(d); dots.push(d); positions.push({ x: 0, y: 0 });
      }
      var mx = 0, my = 0;
      document.addEventListener('mousemove', function(e) { mx = e.clientX; my = e.clientY; });
      (function trailLoop() {
        positions[0].x += (mx - positions[0].x) * 0.35;
        positions[0].y += (my - positions[0].y) * 0.35;
        for (var i = 1; i < TRAIL; i++) { positions[i].x += (positions[i-1].x - positions[i].x) * 0.45; positions[i].y += (positions[i-1].y - positions[i].y) * 0.45; }
        dots.forEach(function(d, i) { d.style.left = positions[i].x + 'px'; d.style.top = positions[i].y + 'px'; });
    ...
    (function() {
      var lastScroll = 0, skew = 0;
      var grids = document.querySelectorAll('.project-grid');
      (function skewLoop() {
        var s = window.scrollY, vel = s - lastScroll; lastScroll = s;
        skew += (vel * 0.3 - skew) * 0.15;
        grids.forEach(function(g) { g.style.transform = 'skewY(' + (-skew * 0.4) + 'deg)'; });
        requestAnimationFrame(skewLoop);
      })();
    })();

    // HOVER IMAGE PEEK ON SECTOR LABELS
    (function() {
      var peek = document.createElement('div');
      peek.style.cssText = ['position:fixed','pointer-events:none','z-index:8500','width:200px','height:130px','border-radius:12px','overflow:hidden','opacity:0','transform:scale(0.85) rotate(-3deg)','transition:opacity .3s ease, transform .4s cubic-bezier(.16,1,.3,1)','box-shadow:0 20px 60px rgba(0,0,0,.3)'].join(';');
      var peekImg = document.createElement('img');
      peekImg.style.cssText = 'width:100%;height:100%;object-fit:cover;';
      peek.appendChild(peekImg); document.body.appendChild(peek);
      document.querySelectorAll('.sector-divider').forEach(function(div) {
        var sk = div.nextElementSibling && div.nextElementSibling.id ? div.nextElementSibling.id.replace('grid-','') : null;
        if (!sk || !PROJECTS[sk] || !PROJECTS[sk][0]) return;
        var thumb = PROJECTS[sk][0].thumb;
        div.addEventListener('mouseenter', function() { peekImg.src = thumb; peek.style.opacity = '1'; peek.style.transform = 'scale(1) rotate(-2deg)'; });
        div.addEventListener('mousemove', function(e) { peek.style.left = (e.clientX + 24) + 'px'; peek.style.top = (e.clientY - 65) + 'px'; });
        div.addEventListener('mouseleave', function() { peek.style.opacity = '0'; peek.style.transform = 'scale(0.85) rotate(-3deg)'; });
      });
    })();
  }
  ...
  // CONTEXT CURSOR LABEL (desktop only)
  (function() {
    if (IS_TOUCH) return;
    var label = document.getElementById('cursor-label');
    if (!label) return;
    var rules = [
      { sel: '.imm-project',    text: 'VIEW' },
      { sel: '.imm-view-btn',   text: 'OPEN' },
      { sel: '.cover-hint',     text: 'EXPLORE' },
      { sel: '.step-card',      text: 'STEP' },
      { sel: '.sector-divider', text: 'SECTION' },
      { sel: '.footer-contact', text: 'CONTACT' },
      { sel: '.lb-nav-btn',     text: 'NAV' },
    ];
    document.addEventListener('mousemove', function(e) { label.style.left = e.clientX + 'px'; label.style.top = e.clientY + 'px'; });
    document.addEventListener('mouseover', function(e) {
      var matched = null;
      rules.forEach(function(rule) { if (e.target.closest(rule.sel)) matched = rule.text; });
      if (matched) { label.textContent = matched; label.classList.add('visible'); }
  ...
  (function() {
    ...
    dotsWrap.style.cssText = ['position:fixed','right:24px','top:50%','transform:translateY(-50%)','display:flex','flex-direction:column','gap:10px','z-index:600','pointer-events:none'].join(';');
    var anchors = [document.getElementById('cover'), document.getElementById('projects'), document.querySelector('.about-strip'), document.querySelector('footer')];
    var dots = anchors.map(function(_, i) {
      var d = document.createElement('div');
      d.style.cssText = ['width:6px','height:6px','border-radius:50%','background:rgba(255,255,255,.3)','transition:background .3s, transform .3s','pointer-events:all','cursor:pointer'].join(';');
      d.addEventListener('click', function() { if (anchors[i]) anchors[i].scrollIntoView({ behavior:'smooth' }); });
      dotsWrap.appendChild(d); return d;
    });
    document.body.appendChild(dotsWrap);
    if (IS_TOUCH) dotsWrap.style.display = 'none';
    window.addEventListener('scroll', function() {
      ...
      anchors.forEach(function(el, i) {
        ...
        var active = sy >= top && sy < bot;
        dots[i].style.background = active ? 'rgba(255,255,255,.9)' : 'rgba(255,255,255,.3)';
